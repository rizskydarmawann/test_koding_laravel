...
@endif
        <div class="card marketing-campaigns">
          <div class="card-header d-flex justify-content-between align-items-center pb-1">
            ...
            <a href="{{ route('admin.create') }}" class="btn btn-sm btn-primary glow mt-md-2 mb-1">ADD</a>
          </div>
          ...
          <div class="table-responsives">
            ...
            <tr>
                ...
                <td class="py-1">{{ $admin->tanggal_lahir }}</td>
                <td class="text-success py-1">{{ $admin->jenis_kelamin }}</td>
