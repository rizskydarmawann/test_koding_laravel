...
<nav class="header-navbar main-header-navbar navbar-expand-lg navbar navbar-with-menu fixed-top" data-bgcolor="bg-white"
    style="background-color: rgb(242, 244, 244); box-shadow: none;">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none">
                                <span class="user-name">{{ Auth::guard('admin')->user()->nama_depan }} {{ Auth::guard('admin')->user()->nama_belakang }}</span>
                                <span class="user-status text-muted">Admin</span>
                            </div>
